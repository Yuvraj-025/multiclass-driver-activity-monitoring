...
MODEL_PATH = os.path.join(BASE_DIR, "model", "best_model_finetuned.keras")  
USE_WEBCAM = False             # NOTE: WSL cannot access the webcam. Set to False to use video file.
                               # For live webcam, run Driver_video_Prediction.py in Windows PowerShell instead.
